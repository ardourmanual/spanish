...
Contenido
Introducción a Ardour 5	1
1. Introducción	5
1.1. Ardour 5 y sus características	5
1.1.1. Qué es "Ardour"	5
1.1.2. Por qué se llama "Ardour"	5
1.1.3. ¿Por qué escribir otro DAW?	5
1.1.4. ¿Que sistema operativo es recomendado para usar Ardour?	6
1.1.5. Requerimientos	6
1.1.6. ¿No es un programa muy complicado?	6
1.2. Convenciones de formateo	7
1.2.1. Tipografía	7
1.2.2. Botones del ratón	7
1.2.3. Avisos	7
1.3. Elementos básicos del interfaz	7
1.3.1. Clics del ratón	8
1.3.2. Relojes	8
1.3.3. Barras de control	8
1.4. Qué es diferente en Ardour	8
1.4.1. „No hay sesión por defecto“	9
1.4.2. „¿Dónde van los Plugins y los envíos?“	9
1.4.3. Un conjunto de herramientas más pequeño	9
1.4.4. Configuración sin restricciones de las entradas y salidas de las pistas	9
1.4.5. Uso de JACK	9
1.5. Hacer funcionar la tarjeta de sonido	10
1.5.1. Probar el interfaz de audio	10
1.5.3. Seleccionar la fuente a capturar	12
2. Iniciar tu primera sesión	13
2.1. Instalar Ardour	13
2.1.1. Descargar y instalar	13
2.2. Configurar una nueva sesión	14
2.2.1. Opciones avanzadas	14
2.2.2. Configurar el audio	15
2.3. Visión general de la interfaz	16
2.3.1. La barra de transporte	16
2.3.2. Ventana Editor	16
2.3.2.1. Modos de edición,	17
2.3.2.2. Modo de zoom	17
2.3.2.3. Modo de ajuste	18
2.3.2.4. Las reglas	18
2.3.2.5. Pistas y Buses	19
2.3.2.6. Mezclador del Editor	19
2.3.2.7. Regiones, Pistas/Buses, Capturas, Grupos de edición, Trozos	19
2.3.3. Controles de la Ventana del Mezclador	19
2.3.4. Cambiar entre ventanas, pegar y despegar ventanas	20
2.4. Crear una Pista o un Bus	20
2.4.1. ¿Cómo se utilizan las Pistas y los Buses?	21
2.4.2. Añadir Pistas y Buses	21
2.4.3. Grabar Audio	21
2.4.3.1. Armar la Pista	22
2.4.3.2. Armar Ardour e Iniciar la grabación	22
2.4.3.3. Evitar Saturación	22
2.4.3.4. No capto ninguna señal cuando grabo...	23
2.5. Comprender el enrutamiento	24
2.5.1. Enrutamiento en Ardour	24
2.5.2. Ejemplo práctico de enrutamiento a Buses	25
2.5.3. Enrutamiento entre Aplicaciones	26
2.5.3.1. Grabar el sonido de una aplicación no JACK en Ardour	26
2.5.3.2. Grabar de aplicaciones con soporte JACK en Ardour	27
2.6 Usar MIDI	28
2.6.1. Que es MIDI?	28
2.6.2. Reproducir notas MIDI con un instrumento virtual: Helm	28
2.6.3. Grabar notas MIDI con un teclado externo	29
2.6.4. Usar controladores externos de MIDI	29
2.6.5. Sistema de MIDI en Linux	30
3. Editar Sesiones	31
3.1. Organizar Pistas	31
3.1.1. Renombrar y Reorganizar	31
3.1.2. Configurar la métrica	31
3.1.4. Utilizar Rangos	32
3.1.5. Configurar un Bucle	32
3.1.6. Trabajar con Regiones	32
3.1.7. Mover Regiones	33
3.1.8. Duplicar Regiones	33
3.1.9. Utilizar Puntos de Edición	34
3.1.10. Marcadores	34
3.1.11. Dividir Regiones	34
3.1.12. Recortar regiones	35
3.1.13. Eliminar regiones	35
3.1.14. Crear Fundidos de entrada y de salida en las Regiones	35
3.1.15. Crear Fundidos cruzados (Crossfades) entre dos Regiones	35
3.1.16. Utilizar Configuraciones de Rejilla	36
3.2. Más operaciones de región	36
3.3. Cambiar Modos de Edición	38
4. Mezcla	42
4.1. Presentar la Banda de Mezcla.	42
4.1.1. La Banda de Mezcla desde arriba hasta abajo	42
4.2. Niveles de Mezcla	44
4.2.1 Utilizar el Atenuador (Fader)	44
4.2.2. Utilizar el Panning (Panorámica o Paneo)	44
4.3. Utilizar Plugins de efectos	45
4.3.1. Formatos de Plugin	45
4.3.2. Procesar efectos	46
4.3.3. La adición de un Plugin de efecto para una pista	47
4.3.4. Editar los parámetros de un Plugin	47
4.3.5. Crear y Utilizar un Envío	48
4.4. Efectos de Dinámica	49
4.4.1. Limitación	49
4.4.2. Compresión	50
4.4.3. Puerta Umbral (Pasa Ruido)	50
4.5. Ecualización	51
4.5.1. Ecualizador de 3-Bandas.	51
4.5.2. Ecualizador Multi-Banda (o Gráfico)	52
4.5.3. Ecualizador paramétrico	52
4.5.3.1. Un ejemplo de uso de un Ecualizador	53
4.6. Automatización	53
4.6.1. Crear una Línea de Automatización	54
4.6.2. Modos de Automatización	54
4.6.3. Crear Automatización de un Plugin	55
4.6.4. Trabajar con Puntos de Automatización	55
4.6.5. Automatización en movimiento	56
4.6.6.¿Cuándo debo utilizar automatización en la región o una pista de automatización?	57
5. Exportar y Guardar	58
5.1. Guardar Sesiones	58
5.1.1. Ardour y formato del archivo de carpetas	58
5.1.2. Moviendo una sesión a otra computadora o disco	59
5.1.3. Guardar plantillas	59
5.2. Exportar una sesión	60
5.2.1. Opción: Upload to SoundCloud	61
5.2.2. Opción: Analizar audio exportado	61
5.3. Exportar Regiones	62
 5.3.1. Exportación Diversas Regiones a la vez	62
5.4. Exportar Rangos	63
5.5. Exportar Audio a Video	63
5.6. Intercambiar con otro DAW	64
6. Appendix	66
6.1 Atajos de teclado	66
6.1.1. Atajos generales	66
6.1.2. Atajos de transporte	66
6.1.3. Atajos en la ventana Editor	66
6.1.4. Atajos de selección de herramientas	66
6.1.5. Atajos en la ventana Mezclador	67
6.1.6. Mover la cabeza de reproducción	67
6.1.7. Mover el cursor de edición	67
6.1.7. Cambiar la visualización	67
6.2. Ayuda y enlaces utiles	68
6.2.1. Foro oficial Ardour	68
6.2.2. Conseguir ayuda vía listas de correo	68
6.2.3. Centro de Ayuda LiberaTuRadio.org	68
6.2.4. Configuración JACK:	68
6.2.5. Plugins:	68
6.2.6. Enlaces relacionados a la producción musical	68
6.3. Glosario	69


1. Introducción
1.1. Ardour 5 y sus características
1.1.1. Qué es "Ardour"
Ardour es un grabador a disco duro completo, libre, de codigo abierto y un puesto de audio digital adecuado para uso profesional. 
Presenta ilimitadas pistas de audio y buses, edición no-destructiva, no-lineal con deshacer ilimitado, y enrutamiento de señal desde y hacia cualquier lugar. 
Soporta formatos de fichero estándar, tales como MIDI, BWF, WAV, WAV64, AIFF y CAF, y puede usar formatos de Plugins LADSPA, LV2, LinuxVST (en GNU/Linux), VST (en Windows) y AudioUnit (en mac OS).
...
1.1.3. ¿Por qué escribir otro DAW?
...
1.1.4. ¿Que sistema operativo es recomendado para usar Ardour?
...
1.1.6. ¿No es un programa muy complicado?
...
1.3. Elementos básicos del interfaz
...
1.4. Qué es diferente en Ardour
...
1.4.1. „No hay sesión por defecto“
...
1.4.2. „¿Dónde van los Plugins y los envíos?“
...
1.4.3. Un conjunto de herramientas más pequeño
...
1.4.4. Configuración sin restricciones de las entradas y salidas de las pistas
...
1.5. Hacer funcionar la tarjeta de sonido
...
1.5.1. Probar el interfaz de audio
...
1.5.3. Seleccionar la fuente a capturar
...
2.2. Configurar una nueva sesión
...
2.2.1. Opciones avanzadas
Si quieres tener más control, por ejemplo en el caso cuando no quieras usar el Bus master, haz clic en el triángulo junto a Opciones avanzadas para ver todas las opciones disponibles: Esto es útil si vas a pasar la salida de Ardour por una mesa de mezclas o si quieres por ejemplo crear sonido surround de 8 canales -7.1. Pero si no sabes que eligir es recomendado que no hagas ningún cambio.
...
2.3. Visión general de la interfaz
...
2.3.2.7. Regiones, Pistas/Buses, Capturas, Grupos de edición, Trozos
...
2.3.3. Controles de la Ventana del Mezclador
...
2.3.4. Cambiar entre ventanas, pegar y despegar ventanas
...
2.4.1. ¿Cómo se utilizan las Pistas y los Buses?
...
2.4.3.2. Armar Ardour e Iniciar la grabación
...
2.4.3.4. No capto ninguna señal cuando grabo...
...
2.5. Comprender el enrutamiento
...
Los puntos verdes representan una conexión. La imagen anterior nos dice que los sonidos entrantes de "sistema: capture_1" (la primera fuente de entrada de la tarjeta de sonido, o el micrófono incorporado del equipo portátil) están entrando en la pista Ardour llamada "Audio 1 in", y también que los sonidos entrantes de "sistema: capture_1" y "sistema: capture_2" van respectivamente a las entradas izquierda y derecha de la pista Ardour nombre "Audio 2."
...
2.5.2. Ejemplo práctico de enrutamiento a Buses
...
2.5.3. Enrutamiento entre Aplicaciones
...
2.5.3.1. Grabar el sonido de una aplicación no JACK en Ardour
...
2.5.3.2. Grabar de aplicaciones con soporte JACK en Ardour
...
2.6.2. Reproducir notas MIDI con un instrumento virtual: Helm
...
2.6.3. Grabar notas MIDI con un teclado externo
...
2.6.4. Usar controladores externos de MIDI
...
2.6.5. Sistema de MIDI en Linux
...
3.1.9. Utilizar Puntos de Edición
...
3.1.14. Crear Fundidos de entrada y de salida en las Regiones
...
3.1.15. Crear Fundidos cruzados (Crossfades) entre dos Regiones
...
3.1.16. Utilizar Configuraciones de Rejilla
...
La función Multi-Duplicar (visto en el trabajo con el capítulo Regiones) es una buena manera de lograr esto. Volver a modo Grab [ G], selecciona todas las regiones, y pulsa [Mayus. + D]. Elegir el número de veces que deseas duplicar el patrón, por ejemplo: 16. Después duplicar nuestra sesión se ve algo como esto:
...
4.1. Presentar la Banda de Mezcla. 
...
4.1.1. La Banda de Mezcla desde arriba hasta abajo 
...
4.2.1 Utilizar el Atenuador (Fader)
...
4.2.2. Utilizar el Panning (Panorámica o Paneo)
...
4.3. Utilizar Plugins de efectos
...
4.3.1. Formatos de Plugin
LADSPA (Linux Audio Developers Simple Plugin API)
Los Plugin LADSPA son el formato "nativo" de Plugin para Ardour. Fueron inicialmente desarrollados para Linux, pero desde entonces han sido portados a mac OS también. Cada vez mas van a ser reemplazado por LV2. 
...
Windows VST en la versión 2.4 (.dll)
AudioUnit (.component) y mac VST en la versión 2.4 (.vst)
LinuxVST en la versión 2.4, LADSPA y LV2 (.so)
...
4.3.3. La adición de un Plugin de efecto para una pista
...
4.3.4. Editar los parámetros de un Plugin
...
4.3.5. Crear y Utilizar un Envío
...
Para crear Envíos en las diferentes pistas haz clic-derecho en el área pos-Fader bajo el Atenuador en una de las Pistas de Audio y selecciona Nuevo Envío y selecciona Bus 1. Hazlo en la banda de cada pista a cual quieres aplicar el efecto (en nuestro ejemplo al bombo, la caja, los platillos y a los redoblantes). 
...
4.4.3. Puerta Umbral (Pasa Ruido)
...
4.5.2. Ecualizador Multi-Banda (o Gráfico)
...
4.5.3.1. Un ejemplo de uso de un Ecualizador
...
En la imagen al lado, la Pista de Automatización llamada Fader (Volumen) está asociada a la Pista llamada Gtr1Amp2. La ganancia de controles de línea de automatización cambian con el tiempo. 

4.6.1. Crear una Línea de Automatización
...
4.6.3. Crear Automatización de un Plugin
...
4.6.4. Trabajar con Puntos de Automatización 
...
4.6.5. Automatización en movimiento
...
4.6.6.¿Cuándo debo utilizar automatización en la región o una pista de automatización?
...
5.1.1. Ardour y formato del archivo de carpetas
...
La carpeta interchange contiene los datos reales de audio de todas las regiones utilizadas en tu sesión. Se llaman por ejemplo:  Audio 1.wav,  Audio 1-1%R.wav . 
Si ya has renombrado cada pista antes de grabar audio en ella tienen los nombres de las pistas correspondientes: cymbal-1.wav, highhat-1.wav, kick-0-bounce.wav, etc, lo que te ayuda a la hora de Buscar el archivo que necesitas por si acaso quieres importarlo en otro programa. 
...
5.1.2. Moviendo una sesión a otra computadora o disco
...
5.1.3. Guardar y Retomar capturas (Snapshots)
...
Tus plantillas se van a guardar en la carpeta /opt/ y en esta en Ardour-5.4.0/share/templates o dependiendo de la versión de Ardour.
En mac OS se encuentra en la carpeta usr/tunombre/.Ardour. 
5.2. Exportar una sesión
...
5.2.1. Opción: Upload to SoundCloud 
...
5.2.2. Opción: Analizar audio exportado
...
5.3.1. Exportación Diversas Regiones a la vez
...
6.1.3. Atajos en la ventana Editor
Atajo
Acción
Mayus + Ctrl + N
...
6.1.4. Atajos de selección de herramientas
Atajo
Acción
R
...
6.1.5. Atajos en la ventana Mezclador
Atajo
Acción
Flecha derecha
...
6.1.6. Mover la cabeza de reproducción
Atajo
Acción
P
...
6.1.7. Mover el cursor de edición
Atajo
Acción
E
...
6.1.7. Cambiar la visualización
Atajo
Acción
Flecha izquierda
...
**Ctrl-f
Mover línea de tiempo hacia6.2. Ayuda y enlaces utiles
6.2.1. Foro oficial Ardour
...
6.2.2. Conseguir ayuda vía listas de correo
...
6.2.3. Centro de Ayuda LiberaTuRadio.org
...
6.2.6. Enlaces relacionados a la producción musical
...
Una escala de números qué progresan según una cierta proporción, tal como exponencialmente (2, 4, 8, 16, 256...). Ambas escalas de tono y ganancia son logarítmicas, mientras que la escala de frecuencia es lineal.
...
Una distancia de 12 semitonos entre dos notas. En Hercios, la proporción de una octava es 2:1. Por ejemplo, la nota 'La' (A) por encima del 'Do' (C) medio tiene una frecuencia de 440 Hz. La nota 'La' (A) una octava por encima son 880 Hz, y una octava por debajo son 220 Hz. 
Ogg Vorbis
...
En audio digital, una muestra es el segmento más pequeño posible de un sonido grabado. En audio-CD, por ejemplo, se necesitan 44.100 muestras para hacer un segundo de sonido grabado, y así podemos decir que la frecuencia de muestreo es de 44.100 Hercios. Las muestras también tienen una profundidad de bits la cual determina el rango dinámico que se puede grabar y reproducir. Profundidades de bits comunes son de 16 (para audio-CD), 24 (para grabación de estudio y DVDs) o 32 (para sonidos dentro del ordenador).
...
La representación visual de un sonido en el dominio temporal. Las Waveforms se dibujan dentro de los rectángulos colorados que representan Regiones en el Lienzo Principal. delante
